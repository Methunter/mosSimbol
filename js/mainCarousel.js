  ...
  $.widget("js.slides", {
		options: {
			...
			fade: {
				...
				crossfade: false, // [Boolean]  add this feature. Crossfade the slides, great for images, bad for text
				easing: "" // [String] Dependency: jQuery Easing plug-in <http://gsgd.co.uk/sandbox/jquery/easing/>
			},
			slide: {
				interval: 500, // [Number] Interval of fade in milliseconds
				browserWindow: true, // [Boolean] Slide in/out from browser window, bad ass
				easing: "" // [String] Dependency: jQuery Easing plug-in <http://gsgd.co.uk/sandbox/jquery/easing/>
			},
			preload: {
			...
			autoHeight: false, // [Boolean]  add this feature. Auto sets height based on each slide
...
//					width: window.innerWidth*.65,
					width: "",//window.innerWidth > 1025 ? window.innerWidth > 1450 ? innerWidth *.45 : innerWidth*.60 : "",
				...
				$(window).resize( $.proxy(function() {
					this.element.css({
						width: "",//window.innerWidth > 1450 ? innerWidth *.45 : innerWidth*.60,
						left:  "",//window.innerWidth > 1025 ?  (window.innerWidth *.06):"",
				});

					this.slidesContainer.css({
						left: ""//(window.innerWidth *.06)//this.options.slide.browserWindow ?  (window.innerWidth - this.options.width) / 2 : ""
					});
				},this));
			}
